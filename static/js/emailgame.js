/* ============================================================
   Email Threat Detective — Game logic
   ============================================================ */
...
const EMAILS = [
  ...
  // ── 1. HSBC Bank ── PHISHING ────────────────────────────────
  {
    ...
    segments: [
      ...
      { id:"s6",  text:"an unknown device in Nigeria",                  sus: true,  reason:"Naming a specific foreign country is a social engineering tactic to amplify fear. Legitimate security alerts describe the device type, not a dramatic location." },
  ...
  // ── 5. Disney+ Prize ── PHISHING ─────────────────────────────
  {
    ...
    segments: [
      ...
      { id:"d7",  text:" has been reserved under your account.\n\nWinning Reference: #8392-LNV-DSNY\n\nTo claim, please confirm your shipping address and pay a ", sus: false },
      { id:"d8",  text:"small handling and delivery fee of £2.99",      sus: true,  reason:"Charging any fee — even a small one — to claim a prize is advance-fee fraud. There is no prize. Only your £2.99 and card details are being stolen." },
      { id:"d9",  text:":\n\n",                                         sus: false },
      { id:"d10", text:"http://disneyplus-loyalty-rewards.claim-prize.net/verify",  sus: true,  reason:"Fake domain. Disney+ only communicates via disneyplus.com — 'claim-prize.net' is a fraudulent payment page." },
  ...
  // ── 6. Grant Thornton Work Experience ── SAFE (harder) ───────
  {
    ...
    senderName: "Rushnara Khanom",
    date: "15 Mar 2022, 17:45",
    isSpam: false,
    fromSuspicious: false,
    subject: "Grant Thornton Access Accountancy Work Experience — Offer Confirmed",
    segments: [
      ...
      { id:"gt4", text:"Congratulations — you have successfully secured a place on our Access Accountancy Work Experience programme in April.", sus: false },
      { id:"gt5", text:" The team and I are looking forward to meeting you virtually.\n\n", sus: false },
      { id:"gt6", text:"The programme will take place online via Zoom from Monday 7th April to Thursday 10th April 2025.", sus: false },
      { id:"gt7", text:" Further details will be sent to you in the coming weeks.\n\n", sus: false },
      { id:"gt8", text:"If you have any questions, please reply to ",    sus: false },
      { id:"gt9", text:"traineerecruitment@uk.gt.com",                  sus: false },
      { id:"gt10",text:" with your query.\n\nKind regards,\nThe Trainee Recruitment Team\nGrant Thornton UK LLP", sus: false },
    ],
    verdict: "safe",
    suspiciousCount: 0,
    cutReward: "",
